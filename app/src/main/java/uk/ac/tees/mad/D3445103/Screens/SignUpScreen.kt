...
@Composable
fun SignUpScreen(vm: PlantViewModel,navController : NavController) {
    val email = remember {
        mutableStateOf("")
    }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column {
            ...
            Row(modifier = Modifier.padding(90.dp)) {
                Image(
                    painter = painterResource(id = R.drawable._0507),
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(16.dp))
            Button(
                onClick = { vm.signUp(context = context, email = email.value, password = password.value) },
            ...
            Text(text = "Already have an account? Log in",
                ...
                modifier = Modifier.clickable {
                    NavigateWithoutBackStack(navController = navController, AppNavigationComponent.LOGINSCREEN)
                })
        }
        Image(
